 ...
 */
//$db_url = 'mysql://root:rewqasdf1@localhost/3beats';
$db_url = 'mysql://username:password@localhost/databasename';
...
//$conf['fb_apikey'] = '76337ed0889759589eeb44bec562d8f2'; //3beats
//$conf['fb_apikey'] = '3067a4dae3c6e762281fc94c7e1aec21'; //3beatsTEMP
$conf['fb_apikey'] = 'ff62e694be393162140e015a82243da8'; //3beatsDevel
/**
...
function three_beats_arg($index = NULL, $path = NULL) {
  static $arguments;
...
if (three_beats_arg(0) == 'admin' || three_beats_arg(0) == 'vbo' || three_beats_arg(2) == 'edit') {   
 $conf = array('theme_default' => 'garland');
}		
